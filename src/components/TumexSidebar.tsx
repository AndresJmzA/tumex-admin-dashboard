...
export function TumexSidebar() {
  ...
  // Component for navigation items with tooltip
    ...
    <TooltipProvider>
      ...
      >
        ...
        <SidebarContent className="px-3 py-4">
          ...
          <SidebarGroup>
            {!collapsed && (
              <SidebarGroupLabel className="text-gray-500 text-xs font-medium mb-2 transition-opacity duration-200">
                MENÚ PRINCIPAL
              </SidebarGroupLabel>
            )}
            <SidebarGroupContent>
        ...
        <SidebarFooter className="border-t border-white/20 p-4">
          {!collapsed && (
            <div className="text-xs text-gray-500 text-center transition-opacity duration-200">
